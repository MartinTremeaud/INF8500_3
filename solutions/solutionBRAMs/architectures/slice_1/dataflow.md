# Data flow report for solutionBRAMs/slice_1
...
digraph "solutionBRAMs/slice_1" {
    ...
    zynq_ddr0 -> sobel0
	controller0 [shape=oval color="#cadcbe" tooltip="controller0 [spacecodesign.com module controller0 1.0]"]
	...
	sobel0 [shape=oval color="#cadcbe" tooltip="sobel0 [spacecodesign.com module sobel0 1.0]"]
	zynq_ddr0 [shape=box color="#fffbe7" tooltip="zynq_ddr0 [spacecodesign.com memory ddr 1.0]"]
}
```